...
exports.getSoftwareById = (req, res) => {
  Libre
    .findById(req.params.softwareId)
    .then((software) => res.status(200).json(software))
    .catch((err) => { throw err.message; });
};
...
exports.getSoftwareByName = (req, res) => {
  Libre
    .find({ name: req.params.softwareName })
    .then((software) => res.status(200).json(software))
    .catch((err) => { throw err.message; });
};
...
exports.getSoftwareByLicense = (req, res) => {
  Libre
    .find({ license: req.params.softwareLicense })
    .then((software) => res.status(200).json(software))
    .catch((err) => { throw err.message; });
};
...
exports.updateSoftware = (req, res) => {
  Libre
    .findByIdAndUpdate(req.params.softwareId, req.body)
    .then(() => Libre.findById(req.params.softwareId))
    .then((software) => res.status(200).json(software))
    .catch((err) => { throw err.message; });
};
...
exports.deleteSoftware = (req, res) => {
  Libre
    .findByIdAndDelete(req.params.softwareId)
    .then((software) => {
      if (software === null) {
